...
# ./scripts/rpc.py bdev_split_create -s 167 nvme0n1 1
./scripts/rpc.py bdev_split_create -s 8200 nvme0n1 1
...
XML_FILE="/home/lzq/opencas_vm/vm01.xml"  # 调整XML文件的目录
...
# 定义
virsh define /home/lzq/opencas_vm/vm01.xml
